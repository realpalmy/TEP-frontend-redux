...
export default function Footer() {
    return (
        <div class="footer-basic">
            <footer>
                <div class="social"><a href="#"><i class="icon ion-social-instagram"></i></a><a href="#d"><i
                    class="icon ion-social-twitter"></i></a><a href="#d"><i class="icon ion-social-facebook"></i></a></div>
